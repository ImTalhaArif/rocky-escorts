import "./globals.css"; import type { Metadata } from "next"; import { Inter, Playfair_Display } from "next/font/google";
      ...
      <header className="sticky top-0 z-50 bg-neutral-950/80 backdrop-blur border-b border-neutral-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm text-neutral-300">
            <a href="#profiles" className="hover:text-white">Companions</a>
            <a href="#experience" className="hover:text-white">Experience</a>
            <a href="#privacy" className="hover:text-white">Discretion</a>
            <a href="#contact" className="px-4 py-2 rounded-full bg-amber-400 text-neutral-900 font-medium hover:bg-amber-300 transition">Book Privately</a>
          </nav>
        </div>
      </header>
      ...
      <footer className="border-t border-neutral-800 bg-neutral-950">
        <div className="max-w-7xl mx-auto px-6 py-10 grid md:grid-cols-2 gap-6 text-sm text-neutral-400">
          <div>
            ...
            <p className="mt-2">Elite companionship platform focused on privacy, consent, and discretion.</p>
          </div>
